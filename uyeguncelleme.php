...
$gc = mysqli_query($baglanti,"SELECT * FROM uyeler WHERE uye_id ='".$_REQUEST['uye_id']."'");
$row_gc = mysqli_fetch_assoc($gc);
}
...
<div class="box-body box-profile"><img class="profile-user-img img-responsive" src="images/uyeler/<?php echo htmlentities($row_gc['uye_resim']); ?>" alt="User profile picture">
    </div>
...
<td><input type="FILE" name="RESIM"></td></tr>  
  <input type="text"  style="display:none" name="komut" value="uyeresmi"  class="form-control"/>
  <input type="text"  style="display:none" name="telefon" value=<?php echo htmlentities($row_gc['telefon']);?>  class="form-control"/>
...
if(isset($_SESSION['login'])=="true" and ($_SESSION['yetki'])>=($_SESSION['superadmin']) ){  	
 $kat_sorgu = mysqli_query($baglanti,"SELECT * FROM yetkiler ORDER BY yetki_id ASC");
	...
	$kat_sorgu = mysqli_query($baglanti,"SELECT * FROM yetkiler yetki_id=1");
} 
...
echo  "<option value='".$dongu["yetki_id"]."'>".$dongu["yetki"]."</option>";
 ...
 ?>
      ...
      <div class="form-group has-feedback">
        <input type="text" name="adi_soyadi" value="<?php echo htmlentities($row_gc['adi_soyadi'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" placeholder="Adı Soyadı">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
	  
	  
	  <div class="form-group has-feedback">
        <input type="text" name="telefon" value="<?php echo htmlentities($row_gc['telefon'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" placeholder="Telefon">
      ...
      <div class="form-group has-feedback">
        <input type="email" name="eposta" value="<?php echo htmlentities($row_gc['eposta'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" placeholder="Email">
      ...
      <div class="form-group has-feedback">
        <input type="password" name="sifre" value="<?php echo htmlentities($row_gc['sifre'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" placeholder="Password">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
	  
      <div class="form-group has-feedback">
        <input type="password" name="sifrer" value="<?php echo htmlentities($row_gc['sifre'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" placeholder="Retype password">
      ...
      <div class="row">
	   ...
	   <input type="hidden" name="komut" value="uyeguncelleme">
      <input type="hidden" name="uye_id" value="<?php echo $row_gc['uye_id']; ?>">
    </form>
