...
<div class="form-group has-feedback"></div> <!-- SADECE BOŞLUK BIRAKMAK İÇİN EKLENDİ -->
...
echo  "<option value='".$dongu["yetki_id"]."'>".$dongu["yetki"]."</option>";
 ...
 ?>
      ...
      <div class="form-group has-feedback">
        <input type="text" name="adi_soyadi" class="form-control" placeholder="Adı Soyadı">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          ...
          <button type="submit" class="btn btn-primary btn-block btn-flat">Üye Ekle</button>
